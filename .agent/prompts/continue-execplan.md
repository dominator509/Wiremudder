...
Read the active ExecPlan Progress, Surprises and Discoveries, Decision Log, Outcomes, source evidence, expected-path amendment, and the last 50 ledger lines. Confirm or lawfully take over the lease. Re-run the last checked milestone sentinel, then resume at the first unchecked milestone and finish the node.
