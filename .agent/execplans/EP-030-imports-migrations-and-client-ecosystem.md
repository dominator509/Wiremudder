...
- Implement every obligation in `.agent/node-contracts/EP-030.md`.
- Own features: WM-FEAT-0120.
- Own requirements: WM-SPEC-020-R07.
...
WireMudder preserves the pinned Mudlet foundation and adds isolated WireCore services. This node depends on EP-010, EP-013, EP-014. It must not assume later capabilities exist. P0 manual gameplay remains independent from optional systems.
...
- `.agent/expected-files/EP-030.discovered.txt`
...
The static fence is `.agent/expected-files/EP-030.txt`. The milestone fence is `.agent/milestone-files/EP-030-Mk.txt`. An inherited path is legal only after `.agent/expected-files/EP-030.discovered.txt` contains source evidence and the exact path.

- `.agent/execplans/EP-030-imports-migrations-and-client-ecosystem.md`
- `.agent/node-contracts/EP-030.md`
- `.agent/expected-files/EP-030.txt`
- `.agent/expected-files/EP-030.discovered.txt`
- `.agent/milestone-files/EP-030-M1.txt`
- `.agent/milestone-files/EP-030-M2.txt`
- `.agent/milestone-files/EP-030-M3.txt`
- `.agent/milestone-files/EP-030-M4.txt`
- `.agent/milestone-files/EP-030-M5.txt`
- `.agent/state/LEDGER.md`
- `.agent/state/source-evidence.jsonl`
- `.agent/state/source-evidence/`
- `.agent/state/COMMANDS.lock.tsv`
- `.agent/state/evidence/EP-030/`
- `scripts/node-verifiers/EP-030.sh`
- `tests/live-fire/LF-030-import-migration-disabled-automation.sh`
- `tests/wiremudder/ep030/`
- `docs/wiremudder/imports/`
...
- Node contract: `.agent/node-contracts/EP-030.md`.
- Accepted specifications: SPEC-005, SPEC-008, SPEC-011, SPEC-021, SPEC-022.
- Live-fire: `LF-030` `import-migration-disabled-automation`.
...
GOAL: Lock the evidence, interfaces, exact inherited integration paths, node verifier, and tests before product implementation for Imports, Migrations, and Client Ecosystem.
...
CHANGE: exact paths in `.agent/milestone-files/EP-030-M1.txt`; inherited paths additionally require the discovered amendment.
...
2. Review owned features: WM-FEAT-0120.
3. Review owned requirements: WM-SPEC-020-R07.
...
RUN:
1. `sh scripts/node-contract-check.sh EP-030`
2. `sh scripts/record-evidence.sh EP-030 M1 "EP-030 M1: ok" -- sh scripts/node-verifiers/EP-030.sh M1`
...
EVIDENCE: `sh scripts/ledger.sh append "${WIREMUDDER_AGENT_ID}" EP-030 MILESTONE_PASS "M1 EP-030 M1: ok; evidence=.agent/state/evidence/EP-030/M1"`

FALLBACK: Support read-only analysis and migration reports for unproven formats; allow only verified Mudlet imports.

COMMIT: `git add -A && git commit -m "[EP-030][M1] evidence contracts and exact path lock"`

### M2: Core behavior and deterministic invariants

GOAL: Implement the smallest real core behavior that satisfies the node contract for Imports, Migrations, and Client Ecosystem inside namespaced boundaries.
...
CHANGE: exact paths in `.agent/milestone-files/EP-030-M2.txt`; inherited paths additionally require the discovered amendment.
...
RUN:
1. `sh scripts/node-contract-check.sh EP-030`
2. `sh scripts/record-evidence.sh EP-030 M2 "EP-030 M2: ok" -- sh scripts/node-verifiers/EP-030.sh M2`
3. `sh scripts/scope-audit.sh EP-030`
...
EVIDENCE: `sh scripts/ledger.sh append "${WIREMUDDER_AGENT_ID}" EP-030 MILESTONE_PASS "M2 EP-030 M2: ok; evidence=.agent/state/evidence/EP-030/M2"`
...
GOAL: Integrate Imports, Migrations, and Client Ecosystem with the actual Mudlet-derived runtime, WireCore boundary, persistence, UI or headless surface, and controlled dependencies as applicable.
...
CHANGE: exact paths in `.agent/milestone-files/EP-030-M3.txt`; inherited paths additionally require the discovered amendment.
...
RUN:
1. `sh scripts/node-contract-check.sh EP-030`
2. `sh scripts/record-evidence.sh EP-030 M3 "EP-030 M3: ok" -- sh scripts/node-verifiers/EP-030.sh M3`
3. `sh scripts/scope-audit.sh EP-030`
...
EVIDENCE: `sh scripts/ledger.sh append "${WIREMUDDER_AGENT_ID}" EP-030 MILESTONE_PASS "M3 EP-030 M3: ok; evidence=.agent/state/evidence/EP-030/M3"`

FALLBACK: Support read-only analysis and migration reports for unproven formats; allow only verified Mudlet imports.

COMMIT: `git add -A && git commit -m "[EP-030][M3] real integration and user visible flow"`

### M4: Forced failures, abuse cases, performance, and operations

GOAL: Break Imports, Migrations, and Client Ecosystem deliberately and prove fail-closed, bounded, observable, recoverable behavior without a P0 or P1 regression.
...
CHANGE: exact paths in `.agent/milestone-files/EP-030-M4.txt`; inherited paths additionally require the discovered amendment.
...
RUN:
1. `sh scripts/node-contract-check.sh EP-030`
2. `sh scripts/record-evidence.sh EP-030 M4 "EP-030 M4: ok" -- sh scripts/node-verifiers/EP-030.sh M4`
3. `sh scripts/scope-audit.sh EP-030`
...
EVIDENCE: `sh scripts/ledger.sh append "${WIREMUDDER_AGENT_ID}" EP-030 MILESTONE_PASS "M4 EP-030 M4: ok; evidence=.agent/state/evidence/EP-030/M4"`

FALLBACK: Support read-only analysis and migration reports for unproven formats; allow only verified Mudlet imports.

COMMIT: `git add -A && git commit -m "[EP-030][M4] forced failures abuse cases performance and operations"`

### M5: Live-fire, evidence closure, and green tag readiness

GOAL: Run the real user outcome for Imports, Migrations, and Client Ecosystem, close every owned feature and requirement with evidence, and make the node eligible for DONE.
...
CHANGE: exact paths in `.agent/milestone-files/EP-030-M5.txt`; inherited paths additionally require the discovered amendment.

CONTENT:
1. Implement and run `LF-030` at `tests/live-fire/LF-030-import-migration-disabled-automation.sh` against real controlled dependencies.
...
RUN:
1. `sh scripts/node-contract-check.sh EP-030`
2. `sh scripts/record-evidence.sh EP-030 M5 "EP-030 M5: ok" -- sh scripts/node-verifiers/EP-030.sh M5`
3. `sh scripts/scope-audit.sh EP-030`
...
EVIDENCE: `sh scripts/ledger.sh append "${WIREMUDDER_AGENT_ID}" EP-030 MILESTONE_PASS "M5 EP-030 M5: ok; evidence=.agent/state/evidence/EP-030/M5"`

FALLBACK: Support read-only analysis and migration reports for unproven formats; allow only verified Mudlet imports.

COMMIT: `git add -A && git commit -m "[EP-030][M5] live fire evidence closure and green tag readiness"`

# 9. Validation and Acceptance

Run `sh scripts/node-verify.sh EP-030` and require `node verify EP-030: ok`. Then run `sh scripts/expected-files-audit.sh EP-030`, `sh scripts/scope-audit.sh EP-030`, feature coverage, spec trace, and the owning live-fire proof. Cite exact evidence paths for every acceptance obligation.
