#!/usr/bin/env sh
# EP-012 M2 unit test: terminal boundary invariants (raw text authority,
# scrollback bound, command history, capture panes).
set -eu
cd "$(dirname "$0")/../../../.."

QT=/opt/qt/6.8.2/gcc_64
HARNESS=/tmp/wm-ep012-m2-term-$$
...
"$HARNESS" terminal || fail "terminal boundary invariants"

echo "unit EP-012 M2 terminal: ok"
