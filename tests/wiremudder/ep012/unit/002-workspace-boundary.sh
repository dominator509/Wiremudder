#!/usr/bin/env sh
# EP-012 M2 unit test: workspace boundary invariants (gauges, themes,
# layout persistence round-trip).
set -eu
cd "$(dirname "$0")/../../../.."

QT=/opt/qt/6.8.2/gcc_64
HARNESS=/tmp/wm-ep012-m2-ws-$$
...
"$HARNESS" workspace || fail "workspace boundary invariants"

echo "unit EP-012 M2 workspace: ok"
