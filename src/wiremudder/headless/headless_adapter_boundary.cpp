...
{
    switch (state_) {
    case HeadlessAdapterState::Loading:
        return QStringLiteral("loading");
    case HeadlessAdapterState::Ready:
        return QStringLiteral("ready");
    case HeadlessAdapterState::Disabled:
        return QStringLiteral("disabled");
    case HeadlessAdapterState::Denied:
        return QStringLiteral("denied");
    case HeadlessAdapterState::Degraded:
        return QStringLiteral("degraded");
    case HeadlessAdapterState::Canceled:
        return QStringLiteral("canceled");
    case HeadlessAdapterState::Unavailable:
        return QStringLiteral("unavailable");
    case HeadlessAdapterState::Error:
