...
enum class Permission { Filesystem, Network, Microphone, AiEgress, Secrets, Routing, Updater, Telemetry, Ui, CommandSend, Memory, Renderer, Audio };
...
inline QString permissionName(Permission p)
{
    ...
    case Permission::AiEgress:
        return QStringLiteral("ai_egress");
    case Permission::Secrets:
        return QStringLiteral("secrets");
    case Permission::Routing:
        return QStringLiteral("routing");
    case Permission::Updater:
        return QStringLiteral("updater");
    case Permission::Telemetry:
        return QStringLiteral("telemetry");
    case Permission::Ui:
        return QStringLiteral("ui");
    case Permission::CommandSend:
        return QStringLiteral("command_send");
    case Permission::Memory:
        return QStringLiteral("memory");
    case Permission::Renderer:
...
{
    static const QHash<QString, Permission> map = {{QStringLiteral("filesystem"), Permission::Filesystem},
...
public:
    ...
    Decision decide(Permission p) const { return m_granted.contains(p) ? Decision::Granted : Decision::Denied; }
