...
QString CopilotPaneQt::stateLabel() const {
    switch (state_) {
        case CopilotPaneState::Loading: return QStringLiteral("loading");
        case CopilotPaneState::Ready: return QStringLiteral("ready");
        case CopilotPaneState::Disabled: return QStringLiteral("disabled");
        case CopilotPaneState::Denied: return QStringLiteral("denied");
        case CopilotPaneState::Degraded: return QStringLiteral("degraded");
        case CopilotPaneState::Canceled: return QStringLiteral("canceled");
        case CopilotPaneState::Unavailable: return QStringLiteral("unavailable");
        case CopilotPaneState::Error: return QStringLiteral("error");
    }
