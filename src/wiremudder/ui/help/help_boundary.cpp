...
{
    switch (state_) {
    case HelpPaneState::Loading:
        return QStringLiteral("loading");
    case HelpPaneState::Ready:
        return QStringLiteral("ready");
    case HelpPaneState::Disabled:
        return QStringLiteral("disabled");
    case HelpPaneState::Denied:
        return QStringLiteral("denied");
    case HelpPaneState::Degraded:
        return QStringLiteral("degraded");
    case HelpPaneState::Canceled:
        return QStringLiteral("canceled");
    case HelpPaneState::Unavailable:
        return QStringLiteral("unavailable");
    case HelpPaneState::Error:
...
{
    switch (mode_) {
    case HelpModeQt::LocalOnly:
        return QStringLiteral("local-only");
    case HelpModeQt::RemoteRedacted:
        return QStringLiteral("remote-redacted");
    case HelpModeQt::Disabled:
        return QStringLiteral("disabled");
    }
    return QStringLiteral("local-only");
}
