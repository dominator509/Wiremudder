...
{
    switch (state_) {
    case SoulPaneState::Loading:
        return QStringLiteral("loading");
    case SoulPaneState::Ready:
        return QStringLiteral("ready");
    case SoulPaneState::Disabled:
        return QStringLiteral("disabled");
    case SoulPaneState::Denied:
        return QStringLiteral("denied");
    case SoulPaneState::Degraded:
        return QStringLiteral("degraded");
    case SoulPaneState::Canceled:
        return QStringLiteral("canceled");
    case SoulPaneState::Unavailable:
        return QStringLiteral("unavailable");
    case SoulPaneState::Error:
