# ADR-0003: Use an Isolated Rust WireCore Sidecar

## Status

Accepted with EP-005 validation
...
Place new AI, memory, voice, renderer coordination, storage, and diagnostics outside the Mudlet process.
